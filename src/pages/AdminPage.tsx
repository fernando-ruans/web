    ...
    <div className={theme.bg + ' flex flex-col items-center justify-center min-h-screen'}>
      <div className="w-full max-w-5xl flex flex-col items-center gap-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center gap-4 border-t-4 border-blue-500 hover:shadow-2xl transition">
            <div className="mb-2"><FaUserCog size={40} color="#2563eb" /></div>
            <h3 className="font-bold text-2xl text-blue-700 mb-1">Relatórios Gerais</h3>
            ...
            <div className="flex flex-col gap-2 w-full">
              <button
                className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded w-full flex items-center justify-center gap-2 transition"
